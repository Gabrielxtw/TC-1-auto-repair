...
public class AttachPartUseCase(IServiceOrderRepository _serviceOrderRepository, IPartRepository _partRepository, IServiceOrderPartRepository _serviceOrderPartRepository)
{
    ...
    public async Task<BaseResponse<ServiceOrderListResponse?>> ExecuteAsync(AttachPartRequest request)
    {
        try
        {
            ...
            if (part is null)
                return new BaseResponse<ServiceOrderListResponse?>(data: null, success: false, error: "Part not found.", StatusCode: "404");
            ...
            if (existingPart is not null)
                return new BaseResponse<ServiceOrderListResponse?>(data: null, success: false, error: "Part already attached to the service order.", StatusCode: "400");
